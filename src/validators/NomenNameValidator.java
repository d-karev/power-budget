...
public class NomenNameValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent comp, Object value) throws ValidatorException {
		...
		if (nomenExists(nomenName, userId)) {
	...
	private boolean nomenExists(String nomenName, int userId) {		
		...
		List nomenList = nomenDb.findByExample(nomen);
		
		return !nomenList.isEmpty();
	}
